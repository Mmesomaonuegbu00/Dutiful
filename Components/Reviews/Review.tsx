        ...
        <div className="w-full pt-[8vh] md:pt-[12vh] pb-[2vh]">
            <div className="flex justify-center flex-col xl:w-[75%] w-[90%] h-full mx-auto">
                <div className="grid relative grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    {/* Image Column */}
                    <div className="relative flex w-full h-95 lg:h-125 order-2 lg:order-1">

                        <div className="absolute inset-0 flex items-center justify-center -z-10">
                            <div className="absolute -z-10 flex items-center justify-center w-50 h-50 lg:w-115 lg:h-115 rounded-full bg-[#603F8B] blur-3xl opacity-70"> <div className=" w-30 h-30  lg:w-105 lg:h-105 bg-white rounded-full" />
                            </div>
                        </div>
